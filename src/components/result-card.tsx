      ...
      <CardContent className="p-6 sm:p-8 bg-card min-h-[72px]">
        ...
        <div>
          ...
          <div className="space-y-2">
            {Array.isArray(persona.recommendations) && persona.recommendations.length > 0 ? (
              ...
              <div className="text-center text-muted-foreground py-8">추천 코스 정보 없음</div>
            )}
          </div>
        </div>
        ...
        <div className="mt-8 space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="font-bold">여행 경비</h4>
              <div className="text-muted-foreground text-sm mt-1">
                {persona.budget ? <BudgetWithExchange budget={persona.budget} /> : <span>정보 없음</span>}
              </div>
            </div>
          </div>
          <div className="flex items-start gap-4">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="font-bold">여행 팁</h4>
              <div className="text-muted-foreground text-sm mt-1">
        ...
        <div className="mt-8 pt-6 border-t flex items-center justify-center gap-2">
          {/*<Button variant="outline" className="rounded-full h-12 px-6" onClick={handleKakaoShare}> 카카오 버튼*/}
          ...
          <Button
            ...
            aria-label={hasLiked ? '오늘은 이미 좋아요를 눌렀어요' : '좋아요'}
          >
