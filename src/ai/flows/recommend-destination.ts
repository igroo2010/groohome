...
All amounts must be in KRW (e.g., 50,000 KRW), do not use other currencies (yen, dollar, euro, etc.).
Each item should have a realistic range (e.g., accommodation 80,000~300,000 KRW, food 20,000~100,000 KRW, activities 10,000~100,000 KRW, etc.), and there should be enough variation between items. For "Other", only include additional costs that may actually occur during travel (e.g., souvenirs, snacks, local transportation, etc.). Do not include unnecessary explanations, strange items, or AI notices. Example: Other: 10,000 KRW (e.g., souvenirs, snacks, local transportation, etc.)
On the last line, write 'Total per night: total amount (KRW)'.
